...
public class inicioFragment extends Fragment {
    ...
    ImageButton imbtnAbc,imbtnAyuda, imbtnSalir,imbtnPlay;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imbtnPlay = (ImageButton) vista.findViewById(R.id.imbtnInicio);
        imbtnAbc = (ImageButton) vista.findViewById(R.id.imbtnAbc);
        imbtnAyuda = (ImageButton) vista.findViewById(R.id.imbtnAyuda);
        imbtnSalir = (ImageButton) vista.findViewById(R.id.imbtnSalir);
        ...
        imbtnAbc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                deslizadorABCFragment abcFrag=new deslizadorABCFragment();
                android.support.v4.app.FragmentTransaction transaction = getFragmentManager().beginTransaction();
